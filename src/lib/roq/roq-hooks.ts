...
export function useCardFindMany<
  T extends Prisma.cardFindManyArgs,
  R extends GetFindResult<Prisma.$cardPayload<DefaultArgs>, T>[],
>(args?: Prisma.SelectSubset<T, Prisma.cardFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useCardFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.card.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCardCount<T extends Prisma.cardCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.cardCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useCardCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.card.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCardFindManyWithCount<
  T extends Prisma.cardFindManyArgs,
  R extends { data: GetFindResult<Prisma.$cardPayload<DefaultArgs>, T>[]; count: number },
>(args?: Prisma.SelectSubset<T, Prisma.cardFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useCardFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.card.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCardFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useCardFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.card.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useGameFindMany<
  T extends Prisma.gameFindManyArgs,
  R extends GetFindResult<Prisma.$gamePayload<DefaultArgs>, T>[],
>(args?: Prisma.SelectSubset<T, Prisma.gameFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useGameFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.game.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useGameCount<T extends Prisma.gameCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.gameCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useGameCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.game.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useGameFindManyWithCount<
  T extends Prisma.gameFindManyArgs,
  R extends { data: GetFindResult<Prisma.$gamePayload<DefaultArgs>, T>[]; count: number },
>(args?: Prisma.SelectSubset<T, Prisma.gameFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useGameFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.game.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useGameFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useGameFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.game.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
