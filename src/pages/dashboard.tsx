...
import { useRoqPlatformUserProfiles, useGameCount, useCardCount, useTeamCount } from 'lib/roq';

import { CardListPage as ShowCaseList } from 'pages/cards';

function DashboardPage() {
  const { session } = useSession();

  const gameStat = useGameCount();

  const cardStat = useCardCount();
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`cards`} passHref legacyBehavior>
                  <Button
