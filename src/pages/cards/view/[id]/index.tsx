...
import { useCardFindFirst, useRoqClient } from 'lib/roq';
...
function CardViewPage() {
  ...
  const queryParams = useMemo<{ include: { game: boolean; user: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useCardFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('card', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/cards/edit/${id}`} passHref legacyBehavior>
                    <Button
