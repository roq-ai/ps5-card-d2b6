...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`PS5 Card`}</title>

        <meta
          name="description"
          content="PS5 Card: A cutting-edge SaaS platform where gamers can effortlessly save their game cards. Elevate your gaming experience today with PS5 Card."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxQUzV8ZW58MHx8fHwxNjk5MDIxOTE4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`PS5 Card: A cutting-edge SaaS platform where gamers can effortlessly save their game cards. Elevate your gaming experience today with PS5 Card.`}
            </Text>
            <Box
