...
import { useGameFindFirst, useRoqClient } from 'lib/roq';

import { GameInterface } from 'interfaces/game';
import { CardListPage } from 'pages/cards';
...
function GameViewPage() {
  ...
  const { data, error, isLoading } = useGameFindFirst(queryParams, {}, { disabled: !id });
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Publisher" text={data?.publisher} />
